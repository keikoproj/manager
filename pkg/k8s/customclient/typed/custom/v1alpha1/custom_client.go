...
import (
	v1alpha1 "github.com/keikoproj/manager/api/custom/v1alpha1"
	"github.com/keikoproj/manager/pkg/k8s/customclient/scheme"
...
// CustomV1alpha1Client is used to interact with features provided by the custom group.
type CustomV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CustomV1alpha1Client) Clusters(namespace string) ClusterInterface {
